package pt.uminho.di.reolangeditor.views;
...
public class ReoLangPatternView extends ViewPart implements IAdaptable{

	/**
	 * The ID of the view as specified by the extension.
	 */
	public static final String ID = "reolangeditor.views.ReoLangPatternView";
