...
import pt.uminho.di.cooplaeditor.editors.outline.ReoLangContentOutlinePage;
import pt.uminho.di.cooplaeditor.views.ReoLangPatternView;
...
public class ReoLangEditor extends AbstractDecoratedTextEditor {
	...
	public void setSelectedPatternGraphModel(ArchPatternAbstractGraph graph){
		...
		for(int i =0 ; i<views.length; i++){
			if(views[i].getId().equals("cooplaeditor.views.ReoLangPatternView")){
