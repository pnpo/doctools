...
public class CooPLaReconcilingStrategy implements IReconcilingStrategy, IReconcilingStrategyExtension{
	...
	public CooPLaReconcilingStrategy(ISourceViewer viewer, CooPLaEditor editor) {
		this.viewer = viewer;
	...
	public void reconcile(IRegion partition) {
		...
		try{
			...
			SimpleSymbol contextSymbol = CooPLaContextUtil.findMainContext(this.editor, offset);
			String text = CooPLaContextUtil.extractTextInContext(this.viewer, contextSymbol, offset);
