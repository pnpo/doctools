 ...
 * 
 */
package pt.uminho.di.cooplaeditor.editors.context;
 ...
 *
 */
public class CooPLaContextUtil {
	 ...
	 */
	public static SimpleSymbol findMainContext(CooPLaEditor editor, int offset) {
		SimpleSymbol root = editor.getCooPLaOutlineModel();
	...
	public static ArrayList<SimpleSymbol> extractSuitableSymbols(CooPLaEditor editor, SimpleSymbol context, String word) {
		ArrayList<SimpleSymbol> result = new ArrayList<SimpleSymbol>();
		boolean is_a_prefix;
		SimpleSymbol model = editor.getCooPLaOutlineModel();
		if(model != null){
