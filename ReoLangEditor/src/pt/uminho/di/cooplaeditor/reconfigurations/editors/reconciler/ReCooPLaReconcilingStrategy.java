...
public class ReCooPLaReconcilingStrategy implements IReconcilingStrategy, IReconcilingStrategyExtension{
	...
	public ReCooPLaReconcilingStrategy(ISourceViewer viewer, ReCooPLaEditor editor) {
		this.viewer = viewer;
