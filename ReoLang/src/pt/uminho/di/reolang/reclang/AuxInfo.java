...
import pt.uminho.di.cp.reconfigurations.Id;
import pt.uminho.di.cp.reconfigurations.Join;
import pt.uminho.di.cp.reconfigurations.Par;
import pt.uminho.di.cp.reconfigurations.Remove;
import pt.uminho.di.cp.reconfigurations.Split;
import pt.uminho.di.reolang.parsing.util.Pair;
import pt.uminho.di.reolang.parsing.util.Triple;

public class AuxInfo {

	public Triple<CoordinationPattern2, CoordinationPattern2, LinkedHashSet<Pair<Node,Node>>> getData(){
	...
	//	xyz.addEnd("z");
		...
		Triple<CoordinationPattern2, CoordinationPattern2, LinkedHashSet<Pair<Node,Node>>> res = new Triple<CoordinationPattern2, CoordinationPattern2, LinkedHashSet<Pair<Node,Node>>>(p, p3, nodes);
		return res;
	}
}
