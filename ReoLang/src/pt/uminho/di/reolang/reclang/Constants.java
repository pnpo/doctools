...
public final class Constants {
	...
	public static final String JAVA_LANG_REFLECT = "java.lang.reflect";
	...
	public static final String REOLANG = "pt.uminho.di.reolang";
	public static final String REOLANG_PARSING = "pt.uminho.di.reolang.parsing";
	public static final String REOLANG_PARSING_UTIL = "pt.uminho.di.reolang.parsing.util";
	
	public static final String RECOOPLA_FILE_EXTENSION = "rpla";
	public static final String COOPLA_FILE_EXTENSION = "cpla";
}
